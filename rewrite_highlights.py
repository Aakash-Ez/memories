...
path = Path("src/pages/Highlights.tsx")

content = """import { collection, orderBy, query } from 'firebase/firestore'
      ...
      <div className="profiles-toolbar">
        <div className="search-field">
          ...
          <input
            ...
            placeholder="Search by batchmate or caption"
          />
        </div>
          ...
          {grouped.map((group) => (
            <section key={group.batch} className="batch-section">
              ...
              >
                <div>
                  <h3>{group.batch}</h3>
                  <span>{group.highlights.length} pieces</span>
                </div>
              ...
              {!collapsed[group.batch] ? (
                <div className="wall-grid highlight-grid">
                  {group.highlights.map((highlight) => {
                    ...
                    return (
                      <button
                        key={highlight.id}
                        className="wall-tile highlight-card"
                        type="button"
                      ...
                      >
                        ...
                        <div className="highlight-body">
                          <p className="highlight-caption">{highlight.caption}</p>
